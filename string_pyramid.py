"""Code wars challenge, I intermittently worked along with Miguel, challenge sourced from: http://www.codewars.com/kata/string-pyramid/train/python."""

def watch_pyramid_from_the_side(characters):
    """Creates visual of side of pyramid."""
...
def count_visible_characters_of_the_pyramid(characters):
    """Counts visible letters from top view."""
    return ((len(characters)*2-1)**2)


def count_all_characters_of_the_pyramid(characters):
    """Counts all tiles required to create pyramid."""
    reversed_characters = characters[::-1]
    output_list = []
...
def watch_pyramid_from_above(characters):
    """Creates a top down view of pyramid."""
    reversed_characters = characters[::-1]
    output_list = []
